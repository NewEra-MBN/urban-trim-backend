const rolePermissions = {
  OWNER: ["manage_salon_profile", "manage_branches", "manage_services", "manage_pricing", "manage_promotions", "create_staff", "edit_staff", "delete_staff", "assign_staff_schedule", "assign_staff_services", "view_all_appointments", "manage_appointments", "manage_customers", "view_reports"],
